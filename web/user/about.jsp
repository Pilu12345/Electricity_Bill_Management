...
<!-- page content -->
	<div style="width: 100%; min-height: 750px;">
		...
		<div class="w3-row-padding w3-large w3-center" style="margin: 32px 0">
			<div class="w3-third">
				<i class="fa fa-map-marker w3-text-blue"></i> Jatani, Bhubaneswar, Odisha
			</div>
			<div class="w3-third">
				<i class="fa fa-phone w3-text-blue"></i> Phone: +91 9776466489
			</div>
			<div class="w3-third">
				<i class="fa fa-envelope w3-text-blue"></i> Email: dashsubhashree100@gmail.com
			</div>
		</div>
