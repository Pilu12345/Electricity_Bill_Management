...
<div class="w3-row-padding" id="about">
    <div class="w3-col l4 12">
      <h3>About</h3>
      <h6>welcome to the Best Hotel in bhubaneswar</h6>
  ...
  <div class="w3-row-padding w3-large w3-center" style="margin:32px 0">
    <div class="w3-third"><i class="fa fa-map-marker w3-text-blue"></i> Bhubaneswar, Khurda, 752050</div>
    <div class="w3-third"><i class="fa fa-phone w3-text-blue"></i> Phone: +91 9776466489</div>
    <div class="w3-third"><i class="fa fa-envelope w3-text-blue"></i> Email: sdas74267@gmail.com</div>
  </div>
