...
<div class="w3-container" id="contact">
    ...
    <i class="fa fa-map-marker w3-text-blue" style="width:30px"></i> Bhubaneswar, Jatani, 756037<br>
    <i class="fa fa-phone w3-text-blue" style="width:30px"></i> Phone: +91 9776466489<br>
    <i class="fa fa-envelope w3-text-blue" style="width:30px"> </i> Email: dashsubhashree100@gmail.com<br>
