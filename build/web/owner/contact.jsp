...
<div class="w3-container" id="contact">
    ...
    <i class="fa fa-map-marker w3-text-blue" style="width:30px"></i> Bhubaneswar, Odisha<br>
    <i class="fa fa-phone w3-text-blue" style="width:30px"></i> Phone: +91 9556885363<br>
    <i class="fa fa-envelope w3-text-blue" style="width:30px"> </i> Email: dashsubhashree100@mail.com<br>
